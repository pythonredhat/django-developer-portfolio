"""
Django settings for django_developer_portfolio project.
...
WSGI_APPLICATION = 'django_developer_portfolio.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.eviron.get('SQL_DATABASE', os.path.join(BASE_DIR, 'db.sqlite3')),
        'USER': os.eviron.get('SQL_USER', 'user'),
        'PASSWORD': os.environ.get('SQL_PASSWORD', 'password'),
        'HOST': os.eviron.get('SQL_HOST', 'localhost'),
        'PORT': os.eviron.get('SQL_PORT', '5432'),
    }
}
